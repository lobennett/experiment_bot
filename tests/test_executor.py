...
TASK_SWITCHING_CONFIG_FULL = {
    ...
    "response_distributions": {
        "task_repeat_cue_repeat": {"distribution": "ex_gaussian", "params": {"mu": 505, "sigma": 55, "tau": 85}},
        "task_repeat_cue_switch": {"distribution": "ex_gaussian", "params": {"mu": 525, "sigma": 55, "tau": 90}},
        "task_switch": {"distribution": "ex_gaussian", "params": {"mu": 530, "sigma": 60, "tau": 95}},
        "first_trial": {"distribution": "ex_gaussian", "params": {"mu": 530, "sigma": 65, "tau": 95}},
    },
